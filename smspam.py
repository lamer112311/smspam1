...
print('''
  ____                                                _  ___   ___  
 / ___| _ __ ___  ___ _ __   __ _ _ __ ___           / |/ _ \ / _ \ 
 \___ \| '_ ` _ \/ __| '_ \ / _` | '_ ` _ \   _____  | | | | | | | |
  ___) | | | | | \__ \ |_) | (_| | | | | | | |_____| | | |_| | |_| |
 |____/|_| |_| |_|___/ .__/ \__,_|_| |_| |_|         |_|\___/ \___/ 
                     |_|        
''')
...
def any_msg(message):
	try:
		...
		print('Похоже у вас не установлено Termux API, без него смс спам будет работать некоректно!')
